...
| 来源 | 目标 | 预期结果 | 实际结果 | 截图 |
|:-----|:-----|:---------|:---------|:-----|
| office | dmz:8080 | 成功 |成功，可正常访问 DMZ Web 服务（HTTP 200/目录列表） |04-access-success.png |
| office | dmz:22 | 失败+LOG |连接被 REJECT，防火墙记录 OFFICE-DMZ-SSH 日志 |05-access-deny.png |
| guest | office:任意 | 失败+LOG |无法访问办公网，防火墙记录 GUEST-OFFICE 日志 |05-access-deny.png |
| guest | dmz:8080 | 失败+LOG |无法访问 DMZ Web 服务，防火墙记录 GUEST-DMZ 日志 | 05-access-deny.png|
| guest | internet:任意 | 成功 |成功访问 Internet，经过 MASQUERADE 完成地址转换 | 04-access-success.png|
| office | internet:任意 | 成功 |成功访问 Internet，经过 MASQUERADE 完成地址转换 |04-access-success.png |
| internet | fw公网IP:8080 | 成功(DNAT到dmz) | 成功访问防火墙公网 IP 的 8080 端口，DNAT 转发至 DMZ Web 服务| 04-access-success.png|
| internet | dmz:22 | 失败 | 无法访问 DMZ 的 SSH 服务，连接被 REJECT| 05-access-deny.png|
